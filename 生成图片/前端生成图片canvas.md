...
```html
<div>
      <el-dialog title="查看证书" top="0" :visible.sync="dialogkaifa" width="600px" center :destroy-on-close='true'>
        <div class="center" style="margin-top:10px;">
          <el-button size="mini" type="primary" @click="createImg" >下载证书</el-button>
        </div>
