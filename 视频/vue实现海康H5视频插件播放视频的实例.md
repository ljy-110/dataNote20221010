...
![image-20231123085724490](E:\ljy\资料\img\image-20231123085724490.png)

一、引入插件包

因为目前项目用的是`vue2.5`，所以我的资源包是放在了`static`目录下面

![image-20231123090827365](E:\ljy\资料\img\image-20231123090827365.png)
...
![image-20231123085515071](E:\ljy\资料\img\image-20231123085515071.png)

功能（一些具体的功能没有使用到，如果想要使用，可以去看看下载包里面的开发文档）

![image-20231123085540057](E:\ljy\资料\img\image-20231123085540057.png)