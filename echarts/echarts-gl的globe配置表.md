...
```js
viewControlAutoRotateDirection: "cw", // 物体自转的方向 'cw'顺时针方向 'ccw'逆时针方向
viewControlAutoRotateSpeed: 10, // 物体自转的速度 单位为角度 / 秒，默认为10 ，也就是36秒转一圈
viewControlAutoRotateAfterStill: 3, // 在鼠标静止操作后恢复自动旋转的时间间隔
viewControlZoomSensitivity: 1, // 鼠标灵敏度
viewControlDistance: 120, // 默认视角距离主体的距离
viewControlMinDistance: 0, // 鼠标控制能拉近到主体的最小距离
viewControlMaxDistance: 520, // 鼠标控制能拉远到主体的最大距离
// 飞线
blendMode: "lighter", // 'lighter'是叠加模式 'source-over'是通过 alpha 混合
effectShow: true, // 开启飞线尾迹特效
effectPeriod: 4, // 尾迹周期
effectConstantSpeed: 100, // 轨迹特效的移动动画是否是固定速度
effectTrailWidth: 4, //尾迹的宽度。
effectTrailLength: 0.1, // 尾迹的长度，范围从 0 到 1，为线条长度的百分比
effectTrailColor: "#fff", //尾迹的颜色
effectTrailOpacity: 1, // 尾迹的不透明度
lineStyleWidth: 2,
lineStyleColor: "red",
lineStyleOpacity: 0.5, // 线条的不透明度
    
    postEffectBloomBloomIntensity: 0.1, // 光晕的强度
depthOfFieldEnable: false, // 开启竟深效果
depthOfFieldFocalDistance: 50, // 初始的焦距
depthOfFieldFocalRange: 30, //完全聚焦的区域范围
depthOfFstop: 2.8, // 镜头的F值，值越小景深越浅
depthOfBlurRadius: 10, //模糊半径
SSAOEnable: false, //开启环境光遮蔽
SSAOQuality: "medium", // 环境光遮蔽的质量
SSAORadius: 2, // 采样半径
SSAOIntensity: 1, // 环境光遮蔽的强度 值越大颜色越深
// 光照相关的设置
lightMainColor: "#fff", // 主光源的颜色
lightMainIntensity: 2, // 主光源的强度
lightMainShadow: false, // 主光源是否投射阴影。默认为关闭
lightMainShadowQuality: "medium", // 阴影质量
lightAmbientColor: "#fff", // 环境光的颜色
lightAmbientIntensity: 0.2, // 环境光的强度
// 地球外部大气层相关设置
atmosphereShow: false, // 是否显示外部大气层
atmosphereColor: "#2A93EB",
atmosphereGlowPower: 6, // 外部大气层发光功率
atmosphereInnerGlowPower: 2, // 外部大气层内发光功率
//视角控制
viewControlProjection: "perspective", // 投影方式，默认为透视投影'perspective'，也支持设置为正交投影'orthographic'
viewControlAutoRotate: true, // 是否开启视角绕物体的自动旋转查看。
```
